                        ...
                        <div class="dashboard_container">
                            <div class="dashboard_container_body p-4">
                                <div class="viewer_detail_wraps">
                                    <div class="viewer_detail_thumb" style=" top:0;">
                                    ...
                                    <div class="caption">
                                        ...
                                        <button type="button" class="btn btn-theme  mt-1 mb-0" onclick="location.href='my-profile.php'">View Profile</button>
                                        ...
                                        <div class="dashboard_container">
                                            ...
                                            <div class="dashboard_container_body p-4 mt-5">
                                                ...
                                                ?>
														...
														<input type="text" class="form-control"  name="university" value="<?php echo $res['university']?>" required>
													     </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>State</label>
                                                            <input type="text" class="form-control" name="state"  value="<?php echo $res['state']?>" required>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>City</label>
                                                            <input type="text" class="form-control" name="city"  value="<?php echo $res['city']?>" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label>Bio</label>
                                                            <textarea  name="bio" class="form-control" required><?php echo $res['bio']?></textarea>
                                                        </div>
