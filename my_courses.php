                    ...
                    <div class="container">
                        ...
                        <div class="row">	
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <!-- Row -->
                                <?php 
							   $result=mysqli_query($conn,"SELECT courses.*,`course-enroll`.*
								 FROM `course-enroll`
								 JOIN courses ON `course-enroll`.stud_id = courses.cid where `course-enroll`.stud_id=".$_SESSION['userid']);
                                ...
                                <div class="row">
                            <?php
                                    $result1=mysqli_query($conn,"SELECT courses.*,`course-enroll`.*, teachers.* 
								 FROM `course-enroll`
								 JOIN courses ON `course-enroll`.course_id = courses.cid 
                                 JOIN teachers ON courses.teacher_id = teachers.id where `course-enroll`.stud_id=".$_SESSION['userid']);
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="education_block_grid style_2">
                                            ...
                                            <div class="education_block_thumb">
                                                <a href="course_play.php?cid=<?php echo $row['cid']?>"><img src="Teacher/assets/course_images/<?php echo $row['thumbnail']?>" class="img-fluid" alt=""></a>
                                            </div>
                                            
                                            <div class="education_block_body">
                                                <h4 class="bl-title"><a href="course_play.php?cid=<?php echo $row['cid']?>"><?php echo $row['course_title']?></a></h4>
                                            </div>
